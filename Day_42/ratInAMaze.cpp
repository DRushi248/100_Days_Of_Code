...
void printAllPath(int maze[][4], int row, int col, int srcx, int srcy, string &output, vector<vector<bool > > &visited) { // if by reference passed then think about backtracking
    ...
    if(isSafe(srcx, srcy, newx, newy, maze, row, col, visited)) {
        ...
        //call recursion
        output.push_back('U'); //agar nech function me nahi hua to 
